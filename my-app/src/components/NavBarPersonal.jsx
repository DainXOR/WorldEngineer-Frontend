import { A, useLocation, useParams, useResolvedPath } from "@solidjs/router";
...
function NavBarPersonal(props) {
    ...
    return (
        <nav class="sticky top-0 flex flex-row w-screen mb-4 p-4 gap-8 text-xl font-bold bg-we-blue-950 text-white outline outline-we-blue-600">
            <A replace href={"/" + userPath + "/projects"} class="flex flex-row justify-center items-center gap-4 m-0 p-0 min-w-max">
            ...
            <div class='nav-item nav-links'>
                <A replace href={"/" + userPath + "/profile"} class="text-center cursor-pointer">
